...
<form action="managerReg2.php" method="post">
  ...
  <div class="form-group">
     <label class="col-sm-2" style="margin-left:365px;">Manager Responsibility :</label>
     
    <div class="col-sm-10">
      <input type="text" name="m_responsibility" class="form-control" placeholder="Manager Responsibility" style="width:400px;margin-left: 554px;margin-top: -34px;" id="a" >
      <p id="345" style="display:none; color:#F81216;">HINTS: You must put your National ID Name.</p>
    </div>
