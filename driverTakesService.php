...
<form action="driverTakesService.php" method="post">
...
CONSTRAINT FKWorker1 FOREIGN KEY (Worker_NID) REFERENCES Worker
		...
		$insertTakes_Service .= "VALUES (TO_DATE('{$service_d}','dd/mm/yyyy'),'Driver','{$_SESSION['cust_id']}','{$w_nid}',";
...
<?php
	...
	$querySelect .= "LICENSE,PHONE_NUMBER FROM WORKER NATURAL JOIN DRIVER ";
