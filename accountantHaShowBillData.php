...
<?php
	...
	$selectSalary .= "JOIN TAKES_SERVICE USING(CUSTOMER_ID) JOIN HOME_ASSISTANCE USING(WORKER_NID)";
...
<div style="width:325px; float:left; height:415px; border: 2px solid black; margin-right:30px; padding:20px 20px 20px 40px;">
    ...
    <form style="margin-bottom:5px;" action="accountantHaShowBillData.php" method="post">
	...
	?>
    			<form action="accountantHaShowBillData.php" method="post">
