<?php include_once("header.php"); ?>
    ...
    <h1 style="font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color:#6E0709" ><center>OUR SERVICES</center></h1> 
        <a class="btn btn-block btn-success" href="haTakesService.php" style="margin-bottom:10px; font-size:20px "><strong>HOME ASSISTANCE</strong></a>
        <a class="btn btn-block   btn-success" href="driverTakesService.php" style="margin-bottom:10px ;font-size:20px"><strong>DRIVER</strong></a>
        <a class="btn btn-block   btn-success" href="sgTakesService.php" style="margin-bottom:10px ;font-size:20px"><strong>SECURITY GUARD</strong></a>
        ...
        <a class="btn btn-block   btn-success" href="networkServiceForm.php" style="margin-bottom:10px ;font-size:20px"><strong>INTERNET SERVICE</strong></a>
         <a class="btn btn-block  btn-success" href="painterServiceForm.php" style="margin-bottom:10px ;font-size:20px"><strong>PLUMBER</strong></a>
