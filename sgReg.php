...
<?php
	if(!empty($_POST))
		if($_POST["flag"] == "sg") {
			...
			$insertDriver = "INSERT INTO SECURITY_GUARD (WORKER_NID,WORKING_HOURS) VALUES ";
			$insertDriver .= "('{$nid}','{$wh}')";	
...
<form action="sgReg.php" method="post" onSubmit="return check()">
  ...
  <div class="form-group">
   ...
   <div class="form-group" id="types" >
    <label class="col-sm-2" >Working Hours: </label>
    
    <div class="col-sm-10" >
      <input name="wh" type="text" class="form-control"  style="width:400px" id="d">
    </div>
   </div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   ...
   <input type="hidden" name="flag" value="sg">
