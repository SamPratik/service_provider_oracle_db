...
<?php
	...
	$selectSalary = "SELECT NAME,WORKER_NID,PHONE_NUMBER,EMAIL_ID,GENDER,DOB,EXPERIENCE FROM ";
	$selectSalary .= "WORKER JOIN  USING(WORKER_NID) JOIN PHONE USING (WORKER_NID)";
...
<div style="width:325px; float:left; height:200px; border: 2px solid black; margin-right:30px; margin-bottom:20px; padding:20px 20px 20px 40px;">
	...
	<?php
			...
			echo "<strong>Worker License: </strong>".$row["GENDER"]."<br/>";
