...
<?php
	...
	$selectSalary .= "JOIN TAKES_SERVICE USING(CUSTOMER_ID) JOIN SECURITY_GUARD USING(WORKER_NID)";
...
<div style="width:325px; float:left; height:415px; border: 2px solid black; margin-right:30px; padding:20px 20px 20px 40px;">
    ...
    <form style="margin-bottom:5px;" action="accountantSgShowBillData.php" method="post">
	...
	?>
    			<form action="accountantSgShowBillData.php" method="post">
