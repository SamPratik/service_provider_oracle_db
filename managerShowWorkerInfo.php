<?php include_once("header.php"); ?>
    ...
    <h1 style="font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color:#6E0709" ><center>MANAGER</center></h1> 
        <a class="btn btn-block btn-success" href="haServiceForm.php" style="margin-bottom:10px; font-size:20px "><strong>HOME ASSISTANCE</strong></a>
        <a class="btn btn-block   btn-success" href="managerShowDriverInfo.php" style="margin-bottom:10px ;font-size:20px"><strong>DRIVER</strong></a>
