...
<?php
	...
	$selectSalary = "SELECT * FROM CUSTOMER_service_VIEW JOIN TAKES_SERVICE USING(WORKER_NID) WHERE SERVICE_TYPE='Driver'";
...
<div style="width:325px; float:left; height:380px; border: 2px solid black; margin-right:30px; margin-bottom:20px; padding:20px 20px 20px 40px;">
	...
	?>
    			...
    			<form action="managerCustomerTookDriver.php" method="post">
