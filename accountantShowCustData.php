<?php include_once("header.php"); ?>
    ...
    <div class="col-lg-5" style="float:left; margin-top:67px;">
...
-->        <a class="btn btn-block btn-success" href="accountantHaShowBillData.php" style="margin-bottom:10px; font-size:20px "><strong>HOME ASSISTANCE</strong></a>
        <a class="btn btn-block   btn-success" href="accountantDriverShowBillData.php" style="margin-bottom:10px ;font-size:20px"><strong>DRIVER</strong></a>
        <a class="btn btn-block   btn-success" href="accountantSgShowBillData.php" style="margin-bottom:10px ;font-size:20px"><strong>SECURITY GUARD</strong></a>
